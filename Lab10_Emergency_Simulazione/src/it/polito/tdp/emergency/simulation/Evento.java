...
public class Evento implements Comparable<Evento> {
	...
	public enum TipoEvento { PAZIENTE_ARRIVA, PAZIENTE_GUARISCE, PAZIENTE_MUORE, DOCTOR_INIZIO_TURNO, DOCTOR_FINE_TURNO, ASSISTANT_INIZIO_TURNO, ASSISTANT_FINE_TURNO	}
